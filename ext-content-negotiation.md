...
Full worked examples for seven ecosystems are provided as companion documents:
...
[CSHARP_REFERENCE.md](CSHARP_REFERENCE.md) (C# / .NET), and
[KOTLIN_REFERENCE.md](KOTLIN_REFERENCE.md) (Kotlin / kotlin-sdk).
